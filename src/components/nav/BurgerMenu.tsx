...
export const BurgerMenu = () => {
    ...
    return (
        <div className="relative text-lg">
            ...
            <div className={`md:hidden block flex flex-col ${toggle ? 'opacity-0 invisible' : 'opacity-100 visible'} transition-all duration-500 absolute mt-3 bg-white p-2 rounded-xl -right-0 top-20`}>
