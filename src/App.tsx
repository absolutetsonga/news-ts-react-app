...
function App() {
  return (
      <>
          <div className="flex flex-col items-center w-[100vw] min-h-[100vh] bg-[#F2F2F2] text-[#333333] subpixel-antialiased">
              <div className="flex justify-center w-full px-[15px] sm:px-[40px]">
